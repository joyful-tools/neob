		...
		<AnimatePresence>
			{dragging && (
				<motion.div
					...
					ref={dropOverlayRef}
					className={cn(
						'absolute inset-0 z-50 flex flex-col items-center justify-center gap-3 rounded-2xl border-4 border-dashed border-edge bg-black/35 p-6 text-white backdrop-blur-xs',
