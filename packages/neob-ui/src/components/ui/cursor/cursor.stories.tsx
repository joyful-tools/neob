...
export const Multiple: Story = {
	render: () => (
		<div className="relative h-64 w-[500px] overflow-hidden rounded-lg border-2 border-black bg-white shadow-cel-inset-sm dark:bg-zinc">
...
function InteractiveCursorContainer() {
	...
	return (
		<div
			...
			className="relative h-64 w-[500px] overflow-hidden rounded-lg border-2 border-black bg-white shadow-cel-inset-sm dark:bg-zinc"
		>
